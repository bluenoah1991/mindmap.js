...
var Node = function () {
    ...
    _createClass(Node, [{
        ...
        value: function _calcElementHeight(element) {
        ...
        value: function _getConnectionPosition() {
            ...
            var height = this._calcElementHeight(this.element);
            if (orientation == 'left') {
                var x = this.box.x;
        ...
        value: function _adjustPosition() {
            ...
            var startX = this.box.x + this.element.width() + this.gapWidth;
            var centerY = this.box.y + this._calcElementHeight(this.element) / 2;
            ...
            for (var i in this.nodes) {
                ...
                var startY_ = startY + (node._calcHeight() - this._calcElementHeight(node.element)) / 2;
